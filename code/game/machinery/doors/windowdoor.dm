/obj/machinery/door/window
	...
	var/base_state = "left"
	max_integrity = 50 //If you change this, consider changing ../door/window/brigdoor/ max_integrity at the bottom of this .dm file
	integrity_failure = 0
	armor = list(MELEE = 15, BULLET = 35, LASER = 40, ENERGY = 50, BOMB = 10, BIO = 100, RAD = 100, FIRE = 70, ACID = 100)
	visible = FALSE
	flags_1 = ON_BORDER_1
	opacity = FALSE
...
/obj/machinery/door/window/brigdoor
	...
	var/id = null
	max_integrity = 200 //Stronger doors for prison (regular window door health is 200)
	reinf = 1
	explosion_block = 1
